...
<main role="main" class="container">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
        <select name="kategori" value="Peralatan Sekolah<?= $produk['kategori']; ?>">
          <option value="Produk Dua Kelinci">Produk Dua Kelinci</option>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="number" name="harga" required class="form-control" placeholder="Harga Produk" value="<?= $produk['harga']; ?>">
    </div>
  </div>
  <div class="form-group row">
