...
//if (isset($array['nama_produk'])) {
    //echo $array['nama_produk'];
//} else {
  //  echo "Key 'nama_produk' is not set.";
//}

//$nama_produk = htmlspecialchars($_GET['nama_produk']);
//$queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE nama_produk='$nama_produk'");
//$produk = mysqli_fetch_array($queryProduk);

// Query untuk mengambil data
$sql = "SELECT nama_produk, stok, gambar, harga FROM produk";
    	...
    	<div class="layout_padding gallery_section">
			<div class="container">
							...
							while ($data = $result->fetch_assoc()) {
								...
								<div class="col-sm-4">
									<div class="best_shoes">
										...
										<div class="star_text">
											<div class="left_part">
												<div class="shoes_price">Rp. <span style="color: #04a9eb; font-size: 70%"><?php echo $data['harga']; ?></span></div>
											</div>
											<div class="right_part">
												<div class="shoes_price">Stok <span style="color: #04a9eb; font-size: 70%"><?php echo $data['stok']; ?></span></div>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="buy_now_bt">
					<button class="buy_text" href="form.input.php">Edit</button>
				</div>
			</div>
		</div>
