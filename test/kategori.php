  ...
  <div class="collection_text">Kategori Produk</div>
    <div class="collection_section layout_padding">
    	<div class="container">
    	    ...
    	    <p class="consectetur_text">TESTESTESTESTESTESTESTEST</p>
    	</div>
    </div>
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Perlatan Rumah Tangga </p>
    					<a href="prt.php" class="shoes_icon"><img src="images/prt.jpg"></a>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Produk Dua Kelinci </p>
    					<a href="dkprod.php" class="shoes_icon"><img src="images/garing.jpg"></a>
						<div class="buy_now_bt">
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Alat Sekolah </p>
    					<a href="skl.php" class="shoes_icon"><img src="images/skl.jpg"></a>
    					<div class="buy_now_bt">
